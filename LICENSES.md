...
Unless a file states otherwise, new source and operational configuration use Apache-2.0. New product specifications and research documents must declare CC-BY-4.0 explicitly before publication in Notion.
...
- **`corpus/`** carries 59 verbatim excerpts from third-party forum posts,
